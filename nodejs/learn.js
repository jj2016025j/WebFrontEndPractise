...
const middleware = function (req, res, next) {
    console.log("中間件 console.log ->" + req.method, "http://localhost:3000" + req.url)
    next()
}
// 應用中間件
app.use(middleware)
...
app.listen(port, function (err) {
    ...
    // console.log("post系統服務中...              http://localhost:" + port + "/post")
    ...
    // console.log("路由系統服務中...              http://localhost:" + port + "/router")
